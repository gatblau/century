...
|---|---:|---:|---:|---:|
| **Containment decays** (`erode_mag` sampled, the default) | **37.3 %** | **47.3 %** | 32.1 % | 11.1 % |
| **Containment holds** (`erode_mag` pinned to 0) | 41.9 % | 40.9 % | 26.7 % | 9.6 % |
...
|---|---:|
| **Disempowerment** | **32.1 %** |
| Oligarchic prosperity | 16.8 % |
| Aligned abundance | 16.2 % |
| Extinction | 11.1 % |
| Turbulent transition | 8.2 % |
| Constrained flourishing (no AGI) | 4.3 % |
| Recovered (post-collapse) | 2.5 % |
| Unknown catastrophe | 2.3 % |
| Muddling degraded (no AGI) | 4.7 % |
| Totalitarian lock-in | 1.3 % |
...
|---|---:|
| **Broadly acceptable** (abundance + oligarchic + flourishing) | **37.3 %** |
| Mixed (turbulent + recovered + muddling) | 15.4 % |
| **Irreversibly bad** (disempowerment + lock-in + collapse + extinction + unknown catastrophe) | **47.3 %** |
| *of which extinction or civilisational collapse* | 11.6 % |
...
|---:|---|---:|---:|---:|
| 1 | Plateau regime (occurring) | 37.1 % | 1.4 % | **−35.7** |
| 2 | Capability growth rate `k` (faster = worse) | 20.1 % | 40.4 % | **+20.3** |
| 3 | Human-paced safety effort | 40.1 % | 24.9 % | **−15.1** |
| 4 | α curvature (higher = later crossing = better) | 37.8 % | 25.1 % | −12.7 |
| 5 | Initial concentration (higher = worse) | 26.4 % | 38.9 % | +12.5 |
| 6 | Race intensity (higher = worse) | 27.6 % | 36.3 % | +8.7 |
| 7 | Institutional responsiveness | 36.1 % | 28.4 % | −7.7 |
| 8 | Containment decay rate (higher = worse) | 28.2 % | 35.8 % | +7.6 |
| 9 | AI-assisted alignment fraction | 35.3 % | 28.2 % | −7.1 |
| 10 | Redistribution capacity | 35.1 % | 28.8 % | −6.2 |
| 11 | AGI threshold (later crossing = better) | 34.8 % | 29.4 % | −5.4 |
| 12–15 | Initial readiness, climate effort, fragility, biodefence | - | - | ≤ ±5 |
...
|---|---:|
| No AGI at all | **0.0 %** |
| Crossed AGI with gap < 0.15 | 7.6 % |
| AGI after 2050 | 13.9 % |
| Crossed AGI with gap > 0.35 | **43.6 %** |
| AGI by 2035 | 45.1 % |
...
The uncomfortable summary: the disempowerment outcome is avoided before the crossing or not at all. Every choice with a double-digit swing works in the window between now and the AGI threshold, and under this model's persistent-risk prior there is no post-crossing recovery lane. That window is measured in years rather than decades: half the ensemble has crossed by 2037 to 2040.

### 3.3 Inside the second most likely outcome: how the good century happens

Aligned abundance (16.3 %, 130,000 worlds) is the counter-story, and the engine's `abundance_profile` block lets it be told from data rather than hope: what these worlds had, what they survived, and how the century unfolded for them, decade by decade.
...
|---|---:|
| P(AGI by 2126) | 89.8 % |
| Median crossing year | **2037** |
| 10th–90th percentile | 2030–2056 |
| P(by 2035) | 39.5 % |
| P(by 2040) | 58.2 % |
| P(by 2050) | 76.5 % |
...
|---|---:|
| Controlled (gap < 0.15) | 11.0 % |
| Contested (0.15–0.35) | 21.0 % |
| Uncontrolled (gap > 0.35) | **68.0 %** |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 2030 | 98.7 % | 0.47 | 0.31 | 0.16 | 0.64 | 0.55 | 0.47 | 1.39 °C | 8.8 | 12.1 % |
| 2040 | 86.6 % | 0.83 | 0.45 | 0.40 | 0.65 | 0.56 | 0.48 | 1.55 °C | 10.1 | 52.4 % |
| 2050 | 72.8 % | 1.18 | 0.62 | **0.44** | 0.66 | 0.59 | 0.50 | 1.70 °C | 11.3 | 68.6 % |
| 2060 | 64.2 % | 1.21 | 0.82 | 0.31 | 0.67 | 0.62 | 0.54 | 1.83 °C | 12.5 | 75.3 % |
| 2070 | 60.1 % | 1.22 | 1.00 | 0.26 | 0.67 | 0.65 | 0.57 | 1.96 °C | 13.3 | 78.7 % |
| 2080 | 57.9 % | 1.23 | 1.00 | 0.24 | 0.68 | 0.67 | 0.59 | 2.08 °C | 13.6 | 80.5 % |
| 2100 | 55.3 % | 1.23 | 1.00 | 0.23 | 0.68 | 0.70 | 0.64 | 2.32 °C | 12.6 | 82.0 % |
| 2120 | 53.3 % | 1.23 | 1.00 | 0.23 | 0.66 | 0.72 | 0.68 | 2.56 °C | 10.2 | 82.3 % |
...
- **2035 to 2060, the long danger.** Most crossings happen in 2030 to 2056, at the widest gap of the century (about 0.40), and because risk persists rather than concentrating in a single decade, the attrition is relentless: the ongoing share falls from 98.7 % to 64.2 %. Roughly a third of all histories suffer their irreversible ending in this twenty-five-year span. The median terminal event across all failed worlds lands at **2048** (10th to 90th percentile 2034 to 2084).
...
|---|---|---:|---:|---:|---:|---:|---:|
| **Race world** | maximal racing, unresponsive institutions, weak safety effort, weak redistribution | 11.6 % | **70.1 %** | 15.4 % | 50.3 % | 0.0 % | 2036 |
| **Prepared world** | low racing, responsive institutions, strong safety effort, strong AI-assisted alignment, strong redistribution | **63.6 %** | 26.4 % | 6.6 % | 16.1 % | 56.0 % | 2037 |
| **Plateau world** | capability stalls below or near threshold | 51.8 % | 6.4 % | 0.9 % | 1.4 % | 10.9 % | 2048* |
| **Fast takeoff** | high growth rate, mid curvature | 32.1 % | 55.8 % | 13.1 % | 39.0 % | 13.1 % | 2033 |
| **Slow lane** | low growth rate, low curvature | 37.6 % | 49.1 % | 11.3 % | 33.7 % | 15.8 % | 2037 |

\* among the plateau worlds that still cross.

Two readings:

- **The same technology, arriving within two years of the same date, yields a 64 %-good world or a 70 %-bad one** depending entirely on the socio-political configuration it arrives into. The prepared world delays the median crossing by only one year against the race world, yet it moves aligned abundance from about 0 % to about 56 %. This is the ensemble's sharpest single fact.
- **Preparation is necessary but not sufficient.** Even the prepared world keeps a roughly one-in-four chance of an irreversibly bad ending (26.4 %). Merely slowing down helps only modestly: the slow lane reaches 37.6 % good, roughly the 37 % headline. A world that crosses slowly but unprepared still faces the same danger afterwards. Only not crossing (plateau, 51.8 % good) or crossing ready changes the outcome decisively.
...
|---:|---|---:|---:|---:|
| 1 | Redistribution capacity | 25.7 % | 46.8 % | **+21.1** |
| 2 | Institutional responsiveness | 26.7 % | 47.1 % | **+20.4** |
| 3 | Plateau regime (occurring) | 35.0 % | 51.5 % | **+16.5** |
| 4 | Capability growth rate `k` (faster = worse) | 46.2 % | 30.2 % | **−16.0** |
| 5 | Initial concentration (higher = worse) | 44.7 % | 28.7 % | −16.0 |
| 6 | Race intensity (higher = worse) | 44.7 % | 30.1 % | −14.7 |
| 7 | Human-paced safety effort | 30.5 % | 43.5 % | +13.0 |
| 8 | α curvature (higher = later crossing = better) | 33.2 % | 41.8 % | +8.6 |
| 9 | Decarbonisation effort | 33.1 % | 41.4 % | +8.4 |
| 10 | Containment decay rate (higher = worse) | 40.6 % | 34.2 % | −6.5 |
| 11 | AI-assisted alignment fraction | 34.6 % | 40.7 % | +6.0 |
| 12 | AGI threshold (later crossing = better) | 34.6 % | 40.2 % | +5.6 |
| 13–15 | Biodefence, initial readiness, fragility | - | - | ≤ ±4 |

Four readings, and the order is itself the model's main sensitivity finding.

- **The socio-political choices now hold the top of the board outright.** Redistribution (+21.1) and institutional responsiveness (+20.4) lead, several points clear of everything else, with human-paced safety effort (+13.0) further back. This is a change: before the plateau regime was corrected to slow growth rather than only cap it (section 6.6), the plateau led the table and the reading was that the strongest fact of nature matched the strongest human choice. A working plateau is a weaker lever than a broken one, because a stalled world now grinds on for decades instead of stopping cleanly, and the outcomes it reaches are more mixed. The distribution-and-governance machinery is now the largest single influence on the broadly acceptable share, though the picture for the worst tails (extinction) still turns on the gap (section 6.2, section 3.4).
- **Time still matters, and the plateau has climbed back to third.** The plateau (+16.5) now sits just above faster growth (−16.0), with racing (−14.7) behind both, so when and whether the crossing happens remains first-tier without leading. It regained ground when the capability-assist correction went in (section 6.9): a world where the paradigm stalls is also a world where AI never accelerates its own development, so the two corrections compound in the same worlds. The social choices still edge ahead of time, but by less than before.
- **Inherited inequality is a real factor.** Initial concentration (−16.0) now sits among the top handful: a world that enters the transition already concentrated is meaningfully likelier to end badly. Biodefence and fragility barely move the broad good-or-bad split (they matter for their own sakes); climate abatement (+8.4) is mid-tier, on a par with AI-assisted alignment.
- **The containment decay rate is mid-table on this measure, and it is the one row here that is not confounded.** Its −7.3 swing sits alongside climate abatement, well behind the top group. Every other row in this table splits worlds into a low quarter and a high quarter of one input, and those inputs were deliberately drawn to move together (section 8). So the worlds racing hardest are also the worlds with the least responsive institutions, and the two rows borrow from each other. The decay rate was drawn on its own, so its row is the only clean one. The variance decomposition that is unconfounded across the board is the Sobol table in `notes/sobol.md`, which is what `strategy.md` ranks the choices on. The decay rate now appears there too, at a total-order index of 0.059, tenth of fourteen, which agrees with the placement this table gives it.
...
|---|---:|---:|
| **Flat window (no deadline)** | **59.1 %** | 28.4 % |
| Decaying, τ ≥ 15 yr | 43.2 % | - |
| Decaying, 8 ≤ τ < 15 yr | 36.2 % | - |
| Decaying, τ < 8 yr | **29.5 %** | **50.8 %** |

The trend runs one way and it is the widest in the model. Moving from a flat window to a fast-closing one (τ < 8 yr) cuts the irreversibly bad share from 59 % to 30 % and lifts the broadly acceptable share from 28 % to 51 %, a roughly 30-point swing, still wider than any human-held choice in section 6. The race to the threshold is robust across the ensemble; the open question is this one, which no survey, benchmark or simulation currently settles. By sampling it rather than choosing it, the headline distribution averages over both priors at even odds. The section 5 named scenarios and the pinned-structure special cases let a reader re-weight toward whichever prior they find more credible. The single largest sensitivity in the whole model is therefore an honest statement of structural ignorance rather than a modelling choice, which is the subject of `strategy.md` section 4.

### 6.2 The conditional structure: everything routes through the gap

| Condition | P(irreversibly bad) |
|---|---:|
| Crossed AGI with gap > 0.35 | **61.7 %** |
| Crossed AGI with gap < 0.15 | 14.7 % |
| AGI by 2035 | 63.8 % |
| AGI after 2050 | 22.8 % |
| No AGI at all | 8.5 % |
...
|---|---:|---:|
| Good (broadly acceptable) | 37.3 % | 32.8 % |
| Aligned abundance | 16.2 % | 11.1 % |
| Disempowerment | 32.1 % | **34.8 %** |
| Irreversibly bad | 47.3 % | 50.8 % |
| Extinction | 11.1 % | 11.8 % |
...
|---|---:|---:|---:|---:|---:|---:|
| 1.90 (before) | 2035 | 47.9 % | 82.2 % | 9.9 % | 36.3 % | 49.6 % |
| **2.40 (now)** | **2037** | **39.5 %** | **76.4 %** | **10.1 %** | **37.5 %** | **47.3 %** |
| 2.80 | 2038 | 34.0 % | 70.6 % | 10.6 % | 38.0 % | 45.1 % |
| 3.20 | 2040 | 29.5 % | 64.3 % | 11.6 % | 38.0 % | 42.8 % |
| 4.00 | 2044 | 23.2 % | 52.3 % | 15.8 % | 36.7 % | 37.8 % |

(Measured with the plateau correction of section 6.7 and the curvature-coupling sign of
section 6.8 in place, so the "before" row restores the ceiling alone rather than the whole
pre-correction model.)

The correction is worth about a point of good century, and it buys it by making the crossing later rather than by making any world safer. Every value from 2.40 to 4.00 puts P(AGI by 2050) inside the published band of section 6.3, so the forecasts do not discriminate between them; only the design target does. A reader who holds the economic-replacement view should run with a ceiling near 4.00, which moves the median seven years and is a modelling decision rather than a correction.

The coupling between growth rate and curvature had the same root cause and is treated separately in section 6.8.

### 6.7 The plateau correction: a stall that only gated

The plateau regime is meant to represent the current AI paradigm running out of road. It worked by lowering a per-world capability ceiling, and growth was throttled by `(C/ceiling)**6 * 0.30`. Both halves misfired.

The sixth power did almost nothing until capability was nearly at the ceiling. It removed 0.5 % of a year's growth at half the ceiling, 3.5 % at seven tenths, and 11.3 % at 0.85. So a stalled world grew at close to full speed right up to its wall, and the regime delayed the median crossing by a single year, 2037 against 2036, in the worlds that still crossed. A stalled paradigm that costs twelve months is not a stall.

The wall was also not a wall. Growth only turned negative once `(C/ceiling)**6 * 0.30` exceeded 1, at 1.22 times the ceiling, so a stalled world overshot its own ceiling by a fifth. That is why 53 % of stalled worlds whose ceiling sat below the AGI threshold crossed it anyway. Between them the two faults meant the regime blocked worlds whose threshold was far above their ceiling and waved the rest through on schedule, with nothing in between.

`CENTURY_V2_PLATDRAG` gives stalled worlds their own throttle shape: exponent 2.0 instead of 6.0, so the brake comes on gradually from further out, and coefficient 0.90 instead of 0.30, so the ceiling is approached rather than overshot. Both are per-world values, so unstalled worlds are untouched and the sub-annual integration path uses the same numbers. No new random draw is taken, so restoring the global shape reproduces the previous model exactly.

The two knobs have to move together, and this is the trap. Lowering the exponent alone makes the brake gradual but raises the point where growth stops, to `(1/coef)**(1/exp)` times the ceiling, so worlds that used to stall grind past their wall instead: at exponent 2.0 with the old coefficient, 99.1 % of stalled worlds reach AGI and the no-AGI share collapses to 0.6 %. A correction that shipped the exponent without the coefficient would read as a plateau fix while deleting the plateau.

| | Before | After |
|---|---:|---:|
| Ceiling overshoot (90th percentile, stalled worlds) | 1.24x | **1.08x** |
| Median crossing, stalled worlds that cross | 2038 | **2048** |
| Lag behind the ensemble median | 2 years | **12 years** |
| Share of stalled worlds reaching AGI | 60.5 % | **31.9 %** |
| No AGI by 2126, whole ensemble | 6.1 % | **10.1 %** |

The last row is the one that closes a gap this document had carried since the beginning. The anchor comment at the top of `century_sim.py` states a design target of 10 to 15 % of worlds reaching 2126 without AGI; the model had been delivering 5.9 %, and nothing had noticed because the arrival band in `anchors.json` is wide enough to accept either.

The correction costs about a point of good century and takes rather more off the bad share. It also demotes the plateau in the sensitivity ranking of section 6, from the largest single influence to sixth, because a stalled world now grinds on for decades and reaches more mixed endings instead of stopping cleanly in a good one. The two largest influences on the century are now both human choices.

### 6.8 The curvature coupling: a sign that cancelled what it meant to reinforce

The continuous priors are coupled through a Gaussian copula (section 8) with three signed pairs. Two are unambiguous: a world racing hard is less responsive, and a world that redistributes also heeds warning shots. The third paired the base growth rate with the curvature exponent at +0.3, annotated in the source as "aggressive scaling: fast base growth-rate and high curvature co-occur".

It delivered the opposite. Measured with the coupling switched off so each parameter acts alone:

| Parameter | Rank correlation with the crossing year |
|---|---:|
| Base growth rate `k` | **-0.838** (higher arrives sooner) |
| Curvature `alpha` | **0.399** (higher arrives later) |

The two run in opposite directions in this model's range, so pairing them positively paired a fast base rate with a slow curvature and the effects cancelled. The consequence is visible in the spread of arrival dates:

| `k,alpha` | 10th | Median | 90th | Spread | By 2035 | After 2050 |
|---|---:|---:|---:|---:|---:|---:|
| +0.3 (before) | 2031 | 2037 | 2051 | 20 yr | 38.1 % | 10.2 % |
| 0.0 | 2030 | 2037 | 2053 | 23 yr | 38.8 % | 12.6 % |
| **−0.3 (now)** | **2030** | **2037** | **2056** | **26 yr** | **39.5 %** | **14.5 %** |

The sign that was supposed to produce aggressive worlds produced the narrowest distribution of the three. The corrected sign widens it by eight years and adds mass at both ends, which is what a coupling described as reinforcing should do.

The original reasoning was not careless, and the reason it failed is the same one behind section 6.6. Where `alpha` is drawn it is annotated `>1 superexp`, and that is correct as mathematics: `dC/dt = k*C**alpha` with `alpha > 1` has a finite-time singularity. But the crossover is at exactly `C = 1`, capability starts at 0.35 and the threshold is 0.68 to 0.92, so the entire run-up sits in the regime where a higher exponent is a brake. The reasoning described the asymptotic behaviour of the equation; the model lives before the asymptote.

The accelerating regime is never reached later either. The ceiling caps capability at about 1.05 times its own value, so the window above `C = 1` is a sliver and the throttle closes it: the rank correlation between curvature and final capability is **+0.038**, and capability at 2126 is identical across curvature quartiles (1.25 against 1.26). In this model curvature only ever delays the crossing; it never accelerates anything.

The correction is a value change in an already-overridable table rather than a new switch: `CENTURY_CORR_JSON='{"k,alpha": 0.3}'` restores the previous behaviour. It costs almost nothing in outcome shares, moving the good share by about a tenth of a point, and its effect is almost entirely on timing spread, which is the quantity sections 6.6 and 6.7 also corrected. Three separate mechanisms had been compressing the same distribution.

One result was hidden by the cancellation. With the coupling corrected, curvature rises from last place in the section 6 sensitivity table, at a swing of −0.0, to eighth at **+9.2**. It had been a parameter with a real effect on the century that the ensemble could not show, because every world with a fast base rate was handed a slow exponent to offset it.

### 6.9 The capability assist: AI helped align its successors but never build them

The readiness step gives deployed capability two routes into safety. It takes a share of this year's capability growth, and it pays an ongoing dividend from capability already deployed, described in the source as aligned-ish systems doing safety research. The capability step had no counterpart. Capability fed readiness in two directions and fed itself in none beyond the fixed curvature, so the model contained AI that helps align its successors and never AI that helps build them.

Nothing in these documents said so, and the omission runs one way. Every result that depends on readiness keeping pace with capability was flattered by it, which is most of them.

`CENTURY_V2_CAPASSIST` multiplies growth by `1 + cap_assist * C`, so capability already deployed makes capability research faster. It is deliberately not degraded by racing the way the readiness assist is: a racing world cuts corners on safety work and hoards results, but racing is exactly when capability research gets the compute, and the growth rate already carries a racing term that would double-count it.

The coefficient is drawn per world from zero to 0.65, and 0.65 is the ceiling the readiness assist already uses. That is a stated assumption rather than a fitted number: whatever share of its capability a world can turn to safety research, it can also turn to capability research. Nothing anchors it, so it joins the containment-decay rate as an input with no published source behind it (section 8).

The coefficient comes from a side random stream rather than the main one, so the main sequence is untouched and pinning the coefficient to zero reproduces the uncorrected model exactly. The containment-decay coefficient is drawn from the main stream and so shifts every later draw, which is why its audit has to compare against a Monte Carlo bar where this one asserts equality.

| Ceiling | Median | P(by 2035) | Uncontrolled at crossing | Good | Irreversibly bad |
|---|---:|---:|---:|---:|---:|
| 0.00 (before) | 2039 | 32.7 % | 61.9 % | 39.2 % | 44.6 % |
| **0.65 (now)** | **2037** | **39.5 %** | **68.0 %** | **37.5 %** | **47.3 %** |
| 0.80 | 2036 | 40.9 % | 69.3 % | 37.0 % | 47.7 % |

P(good) is close to linear across the range and spans about two points end to end, against about four and a half for the containment-decay rate, so the headline is not reported as a second pair; this table is the record instead.

This is the first correction in this section that makes the picture worse. The three before it widened the arrival distribution and bought a point or two of good century each; this one costs about two and pushes six more points of crossings into the uncontrolled band. That is what removing an optimistic asymmetry should do, and it is the reason the asymmetry was worth finding.

It also moved the plateau back up the sensitivity ranking of section 6, from sixth to third. A world where the paradigm stalls is also a world where AI never accelerates its own development, so the two effects compound in the same worlds.
...
1. **The most likely single outcome of the next 100 years is that humanity survives but permanently loses meaningful control of its own history (about 32 %).** Extinction runs about 11.1 % and abundance about 16 %; disempowerment (by AI systems, AI-owning elites, or automated institutions) is the modal ending. Irreversibly bad endings total about 47 %; broadly acceptable ones about 37 %. The bad branch leads by about ten points, and by nothing at all under the containment-holds reading (section 3), so the ordering of the two branches is one of the things this model cannot currently settle.
...
6. **Of the choices humans hold, distribution and governance still edge out safety effort for the broadly acceptable share.** Redistribution (+21.1) and responsiveness (+20.4) lead, with race de-escalation (−14.7 for racing) and safety effort (+13.0) close behind; inherited inequality (−16.0 for initial concentration) is a genuine factor too. The race world ends acceptably 12.0 % of the time; the prepared world 66.7 %, at almost the same median AGI year. Preparation moves aligned abundance from about 0 % to about 61 % while delaying the technology by only about two years. (For the worst tail, extinction, the gap still dominates, section 3.4.)
...
8. **The traditional existential risks are transition modifiers, not protagonists.** Nuclear war (36.1 % chance of at least one use event) and engineered pandemics (40.3 %) permanently terminate only about 0.9 % of worlds (because collapse is now recoverable, a further about 2.6 % collapse and rebuild), well below the 11.6 % extinction-or-collapse aggregate, about 96 % of whose extinctions are AI takeover. Their larger role is corroding trust, governance and readiness during the years those stocks decide the AI outcome. Climate, now sampled with wider tails, reaches a median of about 2.6 °C in surviving worlds, a chronic amplifier of inequality and conflict rather than an ending.
...
- **The structural prior is now sampled, not chosen, and it still prices extinction above the outside-view envelope.** Rather than pick a persistent-risk or a recovery structure, the model samples the takeover-window timescale per world (section 6.1); the headline's 11.1 % extinction averages over both priors at even odds and still exceeds the superforecaster (about 1 %) and domain-expert (about 6 %) medians of the Existential Risk Persuasion Tournament. Readers who weight the outside view more heavily can apply the built-in calibration: reweighting toward the superforecaster target brings the weighted extinction share down to about 2 % and the good share to about 43 % (`calibrate_century.py`; `CENTURY_WEIGHTS=…`). The truth of the century lies somewhere in that bracket, and the bracket is wide because the field's deepest disagreement is wide.
- **Two inputs are invented, and they are the only ones that are.** `erode_mag` is drawn from 0 to 0.30 per world because that scale keeps the erosion term commensurate with the AI-assisted alignment coefficient it works against. Nothing fixes where inside that range the truth sits, P(good) is close to linear across it, and the outside-view anchors do not discriminate between values, so the headline is reported as a pair rather than a point (section 3). The pre-correction model was not neutral on this question: it asserted the value 0, which is the most optimistic point on the range, and never said so. The capability-assist coefficient (`cap_assist`, section 6.9) is the second. It is drawn from 0 to 0.65 because that is the ceiling the readiness assist already uses, which is a statement of symmetry rather than a measurement, and P(good) is close to linear across it as well. The earlier version of this document claimed the decay rate was the only invented input; adding the capability assist made that false, and the claim is corrected here rather than quietly dropped.
- **The capability index has one observable meaning, and it is not enough to test the growth law against history.** The socioeconomic block reads `C` through `autom = clip((C - 0.35) / 0.55)` (`century_sim.py:772`). That is the share of economically relevant work AI can do, and it drives growth, concentration, wellbeing, climate abatement and population. So the index is an affine restatement of the automatable share: 0.35 is nothing automated, 0.90 is everything. The AGI threshold is drawn from 0.68 to 0.92, so it declares AGI somewhere between 60 % and 100 % automation. That places this model in the same family as the economic-replacement definitions of section 6.3 rather than the benchmark ones. That is enough to say what the index means. It is not enough to backcast, and the obstacle is structural. The simulation starts in 2026 with `C` pinned at 0.35 in every world, so there are no earlier dynamics to compare against anything. The automatable share is also clipped at zero below 0.35, so the one observable the index is tied to is identically zero for the whole of the past. This model makes no retrodiction, and a backcast would have nothing to score. The consequence falls on the input that matters most. The base growth rate `k` has the largest total-order index in section 6. Pinning it at the tenth percentile of its own prior gives a 46.7 % good century with the median crossing in 2049, against 30.6 % and 2031 at the ninetieth. Sixteen points of good century and eighteen years of arrival hang on it, wider than every socio-political choice in `strategy.md` put together. Nothing constrains it except the arrival bands of section 6.3, and those are currently loose enough that all three read "already in range". Closing that would need a dated observable series before 2026 and a simulation started early enough to reproduce it, which is a different model rather than a correction to this one.
...
- **Correlated priors are rank correlations.** The parameters are sampled through a Gaussian copula with three signed couplings (racing to responsiveness negative, redistribution to responsiveness positive, growth-rate to curvature negative, corrected from positive on 2026-07-30 for the reason in section 6.8); the quoted magnitudes are rank (Spearman) correlations, the copula's shape-invariant, rather than Pearson.
