...
|---|---:|---:|---:|---:|---:|
| Do nothing (headline) | 40.4 % | 46.6 % | 10.9 % | 31.4 % | 2038 |
| **Make the feasible socio-political choices** | **68.0 %** | **23.7 %** | 6.0 % | 13.9 % | **2039** |
| Socio-levers at their extremes | 76.6 % | 17.5 % | 4.5 % | 9.1 % | 2039 |
| Feasible choices + pace restraint (compute governance) | 75.2 % | 15.4 % | 3.8 % | 7.7 % | 2047 |

The whole strategy is in the second row. Making only the choices already in your hands turns a losing century (47 % bad, 40 % good) into a clearly good one (24 % bad, 68 % good), and it lands AGI in almost the same year. Being ready when it arrives is what does the work, and the technology can keep going at full speed. Compute governance is row four: the feasible choices of row two plus a lower `k`. It trims the bad tail from 23.7 % to 15.4 % and lifts the good share from 68.0 % to 75.2 %, at a cost of about eight years of delay. Even so it ends up just below the 76.6 % the social choices reach at their extremes without it. The social choices make the decisive move; pace restraint trims the tail at the price of time.
...
6. **Cool the race (`race`, swing −15.9): high value, low feasibility.** Racing does unique damage because it hits both sides of the gap at once. It speeds capability up and it eats into the share of safety work you can actually use. Pursue it through verification-based agreements, but keep it as the stretch goal and build the plan on the rest.
