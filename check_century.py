...
DOC_TABLES = [
    ...
    # Section 3, the headline split by thirds of the k prior. k is the dominant
    # uncontrolled input, so the table that says so is pinned like any other result.
    {"id": "s3-k-tertiles", "doc": DOC_PATH, "anchor": "| Third of the `k` prior |",
     "source": "run:800000", "precision": 1,
     "rows": {'Slowest third': {1: 'headline_by_k_tertile.slowest_third.good', 2: 'headline_by_k_tertile.slowest_third.mixed', 3: 'headline_by_k_tertile.slowest_third.irreversible_bad', 4: 'headline_by_k_tertile.slowest_third.extinction', 5: 'headline_by_k_tertile.slowest_third.median_agi_year'}, 'Middle third': {1: 'headline_by_k_tertile.middle_third.good', 2: 'headline_by_k_tertile.middle_third.mixed', 3: 'headline_by_k_tertile.middle_third.irreversible_bad', 4: 'headline_by_k_tertile.middle_third.extinction', 5: 'headline_by_k_tertile.middle_third.median_agi_year'}, 'Fastest third': {1: 'headline_by_k_tertile.fastest_third.good', 2: 'headline_by_k_tertile.fastest_third.mixed', 3: 'headline_by_k_tertile.fastest_third.irreversible_bad', 4: 'headline_by_k_tertile.fastest_third.extinction', 5: 'headline_by_k_tertile.fastest_third.median_agi_year'}}},
    {"id": "readme-k-tertiles", "doc": README_PATH, "anchor": "| If capability grows",
     "source": "run:800000", "precision": 1,
     "rows": {'slowly (bottom third)': {1: 'headline_by_k_tertile.slowest_third.good', 2: 'headline_by_k_tertile.slowest_third.mixed', 3: 'headline_by_k_tertile.slowest_third.irreversible_bad', 4: 'headline_by_k_tertile.slowest_third.median_agi_year'}, 'at the middle rate': {1: 'headline_by_k_tertile.middle_third.good', 2: 'headline_by_k_tertile.middle_third.mixed', 3: 'headline_by_k_tertile.middle_third.irreversible_bad', 4: 'headline_by_k_tertile.middle_third.median_agi_year'}, 'fast (top third)': {1: 'headline_by_k_tertile.fastest_third.good', 2: 'headline_by_k_tertile.fastest_third.mixed', 3: 'headline_by_k_tertile.fastest_third.irreversible_bad', 4: 'headline_by_k_tertile.fastest_third.median_agi_year'}}},
